...
3. For each subset $X_i = \{x_1,..., x_i, i = 1,...,10000$ compute the difference $Y_i = myvar(X_i)− var(X_i)$, where $var(X_i)$ is the standard variance estimation function in R. Plot the dependence $Y_i$ on $i$. Draw conclusions from this plot. How well does your function work? Can
