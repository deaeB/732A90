...
Consider when $\alpha$ become larger,The distribution of data will gradually become like non-random,hence the power will become larger.This is consistent with the visualization we observed,so the quality of the test statistics is good.
